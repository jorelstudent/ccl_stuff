...
def corner(xs, bins=20, range=None, weights=None, color="k",
           smooth=None, smooth1d=None, intens=None,
    ...
    **hist2d_kwargs
    ...
    for i, x in enumerate(xs):
        ...
        for j, y in enumerate(xs):
            ...
            hist2d(y, x, ax=ax, range=[range[j], range[i]], weights=weights, intens=intens,
            ...
            if j > 0:
                ...
                ax.yaxis.set_major_formatter(
                    ScalarFormatter(useMathText=use_math_text))
    fig.suptitle('Corner Plot of Stuff')
    cax = ax.imshow(intens)
    fig.colorbar(cax)
    return fig
...
def hist2d(x, y, bins=20, range=None, weights=None, levels=None, smooth=None,
           ...
           contour_kwargs=None,intens=None, contourf_kwargs=None, data_kwargs=None,
           **kwargs):
    """
    ...
    data_kwargs : dict
        Any additional keyword arguments to pass to the `scatter` method when
